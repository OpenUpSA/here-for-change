"""
Django settings for here_for_change project.
...
INSTALLED_APPS = [
    ...
    "here_for_change.municipalities.apps.MunicipalitiesConfig",
...
ROOT_URLCONF = "here_for_change.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": ["here_for_change/templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
                ...
                "here_for_change.municipalities.context_processors.ga4_tag"
            ],
        },
    },
]

WSGI_APPLICATION = "here_for_change.wsgi.application"
